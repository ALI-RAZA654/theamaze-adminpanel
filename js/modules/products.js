            ...
            <div id="productForm" class="grid grid-cols-1 md:grid-cols-2 gap-8 max-h-[80vh] overflow-y-auto pr-4 custom-scrollbar">
                ...
                <div class="col-span-1 md:col-span-2 pt-6 border-t border-white/5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-[10px] font-black uppercase tracking-widest text-white/40 mb-2">Size Chart Alignment</label>
                            <input type="text" id="p_sizeChart" class="w-full admin-input text-[9px] mb-2" placeholder="URL">
    ...
    async handleSaveProduct(id = null) {
        ...
        for (const entry of variantEntries) {
            ...
            if (vName) {
                ...
                if (vImg) {
                    variants.push({ colorName: vName, image: vImg });
                }
            }
        }
